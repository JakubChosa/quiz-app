...
export default function QuizDisplay(props) {
  ...
  if (optionBackground === "quiz") {
    ...
    displayOpitons = item.options.map((option) => {
      let wrongAnswerBackground =
        option !== correct_answer && option === user_answer
          ? "result-wrong-answer"
          : "";
      let correctAnswerBackground =
        option === correct_answer ? "result-correct-answer" : "";
      return (
        <button
  ...
  return (
    <div className="question-container">
      ...
      <div className="question-options">{displayOpitons}</div>
